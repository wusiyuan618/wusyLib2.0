package com.wusy.wusylibrary.activity.uploadFile.localAum.common;
    ...
    public synchronized void initImage() {
        ...
        while (cursor.moveToNext()) {
            ...
            if (file.exists()) {
                ...
                //获取大图URI
                Uri imgUri=MediaStore.Images.Media.EXTERNAL_CONTENT_URI.buildUpon().
